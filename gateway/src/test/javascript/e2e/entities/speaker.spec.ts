...
describe('Speaker e2e test', () => {
    ...
    it('should load Speakers', () => {
        ...
        expect(speakerComponentsPage.getTitle())
            .toMatch(/Speakers/);
    ...
    it('should load create Speaker dialog', () => {
        ...
        expect(speakerDialogPage.getModalTitle())
            .toMatch(/Create or edit a Speaker/);
    ...
    it('should create and save Speakers', () => {
        ...
        speakerDialogPage.setBioInput(absolutePath);
...
export class SpeakerDialogPage {
    ...
    bioInput = element(by.css('input#file_bio'));
