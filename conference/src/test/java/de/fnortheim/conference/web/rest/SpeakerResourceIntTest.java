...
import de.fnortheim.conference.domain.Speaker;
import de.fnortheim.conference.repository.SpeakerRepository;
...
import static de.fnortheim.conference.web.rest.TestUtil.createFormattingConversionService;
...
public class SpeakerResourceIntTest {
    ...
    public void createSpeaker() throws Exception {
        ...
        assertThat(testSpeaker.getFirstname()).isEqualTo(DEFAULT_FIRSTNAME);
    ...
    public void updateSpeaker() throws Exception {
        ...
        Speaker testSpeaker = speakerList.get(speakerList.size() - 1);
        assertThat(testSpeaker.getFirstname()).isEqualTo(UPDATED_FIRSTNAME);
